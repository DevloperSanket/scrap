                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-3">
                                    <input type="file" name="image" id="fileUpload" value="{{ $card_edit->image }}" class="form-control">
                                    <div id="image-holder"></div>
                                    <span class="text-danger error-text image_error"></span>
                                </div>
                                <div class="form-group mt-3">
                                    <input type="text" name="price" class="form-control" value="{{ $card_edit->price }}" placeholder="Enter Price">
