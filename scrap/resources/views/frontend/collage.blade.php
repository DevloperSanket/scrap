...
<div class="container">
    <div class="row">
        <div class="col-md-12 mt-5 slide-in-left">
            <h3 class="text-decoration-underline">Collage Institution Scrap <span style="color:#4baf47">Service</span></h3>
        </div>
    </div>
</div>
<div class="container mb-5">
    <div class="row mt-4">
        <div class="col-md-6 slide-in-left">
            <img class="img-thumbnail mt-2 zoom-in-out" src="{{ asset('frontend/theam/assets/images/service/collage1.jpg') }}" width="580px"
                alt="">
        </div>
        <div class="col-md-6 slide-in-left">
            <p>
            <h3>We provide <span style="color:#4baf47">Collage Institution Scrap Service</span></h3>
        ...
        <div class="col-md-6 mt-5 text-center slide-in-right">
            <img class="img-thumbnail zoom-in-out" src="{{ asset('frontend/theam/assets/images/service/collage2.jpg') }}"
