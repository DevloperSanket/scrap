...
<main>
        ...
        <div class="swiper banner-three__slider banner-five__slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slide-bg"
                        data-background="{{ asset('frontend/theam/assets/images/banner/banner-five-bg.jpg') }}"></div>
                    <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="slide-bg"
                        data-background="{{ asset('frontend/theam/assets/images/banner/banner-five-bg2.jpg') }}"></div>
                    <div class="container">
                        <div class="banner-three__content banner-five__content">
                            <h4 data-animation="fadeInUp" data-delay="1s">The Green Canvas</h4>
                            <h1 data-animation="fadeInUp" data-delay="1.3s">The Healing Power <br> of Gardening</h1>
                ...
                <div class="swiper-slide">
                    <div class="slide-bg"
                        data-background="{{ asset('frontend/theam/assets/images/banner/banner-five-bg3.jpg') }}"></div>
                    <div class="container">
                        <div class="banner-three__content banner-five__content">
                            <h4 data-animation="fadeInUp" data-delay="1s">The Green Canvas</h4>
                            <h1 data-animation="fadeInUp" data-delay="1.3s">The Healing Power <br> of Gardening</h1>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="1.2s" data-wow-delay=".2s">
                    <div class="donation__item blog-two__item bor view__item">
                        <div class="blog-two__image mb-30">
                            <div class="image">
                                <img src="{{ asset('frontend/theam/assets/images/view/view-image1.jpg') }}"
                                    alt="image">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="1.4s" data-wow-delay=".4s">
                    <div class="donation__item blog-two__item bor view__item">
                        <div class="blog-two__image mb-30">
                            <div class="image">
                                <img src="{{ asset('frontend/theam/assets/images/view/view-image2.jpg') }}"
                                    alt="image">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="1.6s" data-wow-delay=".6s">
                    <div class="donation__item blog-two__item bor view__item">
                        <div class="blog-two__image mb-30">
                            <div class="image">
                                <img src="{{ asset('frontend/theam/assets/images/view/view-image3.jpg') }}"
                                    alt="image">
                            </div>
                        </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-xl-6">
                    <div class="involve-two__image">
                        <img src="{{ asset('frontend/theam/assets/images/about/about-five-image.png') }}"
                            alt="image">
                        <div class="image-sm">
                            <img src="{{ asset('frontend/theam/assets/images/involve/involve-sm.jpg') }}"
                                alt="image">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="involve-two__item">
                        <div class="section-header mb-4">
                            <h5 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                                    src="{{ asset('frontend/theam/assets/images/icon/leaf.svg') }}" alt="image">
                                ABOUT devgren NGO</h5>
                            <h2 class="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">Growth and Glow
                                Illuminating Paths to Wellness in Your Garden</h2>
                            <p class="wow fadeInUp" data-wow-duration="1.6s" data-wow-delay=".6s">We want to live on
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="work-five__head-image wow fadeInUp float-start float-lg-end"
                            ...
                            <img src="{{ asset('frontend/theam/assets/images/work/how-image1.png') }}"
                                alt="image">
                        </div>
                    </div>
                </div>
    ...
    <section class="achievement-five">
        <div class="container">
            <div class="achievement-five__wrp bg-image"
                data-background="{{ asset('frontend/theam/assets/images/bg/achievement-bg.jpg') }}">
                ...
                <div class="achievement-five__bg-overlay">
                    <img src="{{ asset('frontend/theam/assets/images/bg/achievement-bg-image.jpg') }}"
                        alt="image">
                </div>
            </div>
        </div>
    ...
    <section class="project-five pt-130">
        <div class="section-header text-center">
            <h5 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                    src="{{ asset('frontend/theam/assets/images/icon/leaf.svg') }}" alt="image"> COMPLETED PROJECT
            </h5>
            <h2 class="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">recent complete project <br> by
                devgren</h2>
        </div>
        <div class="row g-0">
            <div class="col-xxl-3 wow fadeInDown col-lg-6" data-wow-duration="1.2s" data-wow-delay=".2s">
                <div class="project-five__image">
                    <img src="{{ asset('frontend/theam/assets/images/project/project1.jpg') }}" alt="image">
                </div>
            </div>
            ...
            <div class="col-xxl-3 wow fadeInDown col-lg-6" data-wow-duration="1.6s" data-wow-delay=".6s">
                <div class="project-five__image">
                    <img src="{{ asset('frontend/theam/assets/images/project/project2.jpg') }}" alt="image">
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-lg-6 wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">
                <div class="project-five__item sub-bg">
                    <div class="project-five__content bg-white">
                        <h3><a href="project-single.html">How to find inspiring solution and movement Leverage agile
                                frameworks</a>
                        </h3>
                        <p>We maintain a busy network of forestry and social development staff
                            along with local
            ...
            <div class="col-xxl-3 col-lg-6 wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">
                <div class="project-five__image">
                    <img src="{{ asset('frontend/theam/assets/images/project/project3.jpg') }}" alt="image">
                </div>
            </div>
            ...
            <div class="col-xxl-3 col-lg-6 wow fadeInUp" data-wow-duration="1.8s" data-wow-delay=".8s">
                <div class="project-five__image">
                    <img src="{{ asset('frontend/theam/assets/images/project/project4.jpg') }}" alt="image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="team pt-130 pb-130">
        <div class="container">
            <div class="blog__head-wrp mb-65">
                <div class="section-header m-0">
                    <h5 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="{{ asset('frontend/theam/assets/images/icon/leaf.svg') }}" alt="image"> OUR TEAM
                        MEMBERS</h5>
                    <h2 class="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">devgren awesome team</h2>
                </div>
            ...
            <div class="swiper team__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="team__item">
                            <div class="team__item-image">
                                <img src="{{ asset('frontend/theam/assets/images/team/team1.png') }}" alt="image">
                    ...
                    <div class="swiper-slide">
                        <div class="team__item">
                            <div class="team__item-image">
                                <img src="{{ asset('frontend/theam/assets/images/team/team2.png') }}" alt="image">
                                <div class="team__item-image-icon social-icon">
                                    <a href="#0"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#0"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#0"><i class="fa-brands fa-linkedin-in"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="team__item">
                            <div class="team__item-image">
                                <img src="{{ asset('frontend/theam/assets/images/team/team3.png') }}" alt="image">
                                <div class="team__item-image-icon social-icon">
                                    <a href="#0"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#0"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#0"><i class="fa-brands fa-linkedin-in"></i></a>
                    ...
                    <div class="swiper-slide">
                        <div class="team__item">
                            <div class="team__item-image">
                                <img src="{{ asset('frontend/theam/assets/images/team/team4.png') }}" alt="image">
                                <div class="team__item-image-icon social-icon">
                                    <a href="#0"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#0"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#0"><i class="fa-brands fa-linkedin-in"></i></a>
    ...
    <section class="donation pt-130 pb-130"
        data-background="{{ asset('frontend/theam/assets/images/bg/donation.jpg') }}">
            ...
            <div class="swiper donation-five__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="donation__item">
                            <div class="image mb-30">
                                <img src="{{ asset('frontend/theam/assets/images/donation/01.jpg') }}"
                                    alt="image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="donation__item">
                            <div class="image mb-30">
                                <img src="{{ asset('frontend/theam/assets/images/donation/04.jpg') }}"
                                    alt="image">
                            </div>
                            <div class="donation__item-progress-wrp">
                                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="swiper-slide">
                        <div class="donation__item">
                            <div class="image mb-30">
                                <img src="{{ asset('frontend/theam/assets/images/donation/03.jpg') }}"
                                    alt="image">
                            </div>
                            <div class="donation__item-progress-wrp">
                                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="swiper-slide">
                        <div class="donation__item">
                            <div class="image mb-30">
                                <img src="{{ asset('frontend/theam/assets/images/donation/05.jpg') }}"
                                    alt="image">
                            </div>
                            <div class="donation__item-progress-wrp">
                                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="swiper-slide">
                        <div class="donation__item">
                            <div class="image mb-30">
                                <img src="{{ asset('frontend/theam/assets/images/donation/06.jpg') }}"
                                    alt="image">
                            </div>
                            <div class="donation__item-progress-wrp">
                                <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="container">
            <div class="testimonial__head-wrp mb-65">
                <div class="section-header m-0">
                    ...
                    <h2 class="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">devgren loves people</h2>
                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial__item">
                            <div class="testimonial__item-head">
                                <div class="testimonial__item-head-info">
                                    <div class="testimonial__item-head-info-image">
                                        <img src="{{ asset('frontend/theam/assets/images/testimonial/02.png') }}"
                                            alt="image">
                                    </div>
                                    <div class="testimonial__item-head-info-con">
    ...
    <section class="blog pt-130 pb-130">
        <div class="container">
            <div class="blog__head-wrp mb-65">
                <div class="section-header m-0">
                    <h5 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s"><img
                            src="{{ asset('frontend/theam/assets/images/icon/leaf.svg') }}" alt="image"> LATEST
                        NEWS</h5>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-7">
                                            <div class="image">
                                                <img src="{{ asset('frontend/theam/assets/images/blog/01.jpg') }}"
                                                    alt="image">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-7">
                                            <div class="image">
                                                <img src="{{ asset('frontend/theam/assets/images/blog/03.jpg') }}"
                                                    alt="image">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-7">
                                            <div class="image">
                                                <img src="{{ asset('frontend/theam/assets/images/blog/04.jpg') }}"
                                                    alt="image">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-xl-4 col-lg-6 wow fadeInRight" data-wow-duration="1.4s" data-wow-delay=".4s">
                    <div class="blog__item-right">
                        <a href="blog-single.html" class="image d-block">
                            <img src="{{ asset('frontend/theam/assets/images/blog/02.jpg') }}" alt="image">
                        </a>
    ...
    <div class="our-info" data-background="{{ asset('frontend/theam/assets/images/bg/our-info.jpg') }}">
        <div class="container">
